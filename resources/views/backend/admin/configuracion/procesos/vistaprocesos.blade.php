                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="250" class="form-control" id="nombre-editar" placeholder="Nombre" autocomplete="off">
                                    </div>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('/admin/procesos/tabla/index') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/procesos/tabla/index') }}";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function editar(){
            ...
            if(nombre.length > 250){
                toastr.error('Nombre máximo 250 caracteres');
                return;
            }
